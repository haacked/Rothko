...
if NOT "%RunBuild%"=="" (
"tools\FAKE.Core\tools\Fake.exe" "script\build.fsx" "target=BuildApp" "buildMode=%BUILDMODE%"
)

"tools\FAKE.Core\tools\Fake.exe" "script\build.fsx" "target=%TARGET%" "buildMode=%BUILDMODE%"
