...
namespace Rothko
{
    public interface IFileFacade
    {
        ...
        /// <param name="path">The file to check.</param>
        /// <exception cref="T:System.ArgumentException">
        ///   <param name="path"/> is a zero-length string, contains only white space, or contains one
        ///     or more invalid characters as defined by the System.IO.Path.GetInvalidPathChars()
        ///     method.
        /// </exception>
        /// <exception cref="T:System.ArgumentNullException"><param name="path"/> is null. </exception>
        /// <exception cref="T:System.DirectoryNotFoundException">
        ///   The specified <param name="path"/> is invalid (for example, it is on an unmapped drive).
        /// </exception>
        /// <exception cref="T:System.IO.FileNotFoundException">
        ///   <param name="path" /> was not found.
        /// </exception>
        /// <exception cref="T:System.IO.PathTooLongException">
        ///   The specified <param name="path"/>, file name, or both exceed the system-defined maximum length. For example, on
        ///   Windows-based platforms, paths must be less than 248 characters, and file names must be less than
        ///   260 characters. The specified path, file name, or both are too long.
        /// </exception>
        /// <exception cref="T:System.IO.IOException">
        ...
        /// </exception>
        /// <exception cref="T:System.UnauthorizedAccessException">
        //  The caller does not have the required permission.-or- <param name="path"/> is a directory.-or-
