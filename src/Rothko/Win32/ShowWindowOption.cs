...
namespace Rothko
{
    public enum ShowWindowOption
    {
        ...
        ShowMinimize = 6,
        /// <summary>
        /// Displays the window as a minimized window. This value is similar to <see cref="ShowMinimized"/>, except the
        /// window is not activated.
        /// </summary>
        ShowMinNoActive = 7,
        /// <summary>
        /// Displays the window in its current size and position. This value is similar to <see cref="Show"/>, except
        ...
        Restore = 9,
        /// <summary>
        /// Sets the show state based on the <see cref="ShowWindowOption"/> specified in the STARTUPINFO structure
